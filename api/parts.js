...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    if(action==='update_part'){
      ...
      if(!field||field==='quantity')await sql`UPDATE parts_inventory SET quantity=${value!==undefined?value:quantity},updated_at=NOW() WHERE id=${id}`;
