  ...
  if(action==='migrate') {
    await sql`CREATE TABLE IF NOT EXISTS tasks (
      ...
      due_date DATE, due_time TIME, shift TEXT DEFAULT 'Any',
      recurring TEXT DEFAULT 'none', recurring_days TEXT,
      steps JSONB DEFAULT '[]',
    ...
    await sql`CREATE TABLE IF NOT EXISTS task_instances (
      ...
      company_id INTEGER REFERENCES companies(id), assigned_to INTEGER REFERENCES users(id),
    ...
    await sql`CREATE TABLE IF NOT EXISTS task_messages (
      ...
      from_user_id INTEGER REFERENCES users(id), to_user_id INTEGER REFERENCES users(id),
    ...
    await sql`CREATE TABLE IF NOT EXISTS engagement_logs (
      id SERIAL PRIMARY KEY, company_id INTEGER REFERENCES companies(id),
      user_id INTEGER REFERENCES users(id), session_date DATE NOT NULL DEFAULT CURRENT_DATE,
