...
async function trimRenderAnalytics(){
  ...
  function buildTable(rankings,teamAvg,days){
    ...
    rankings.forEach(function(r,i){
      ...
      h+='<td style="padding:5px 8px"><button class="ttb" data-sid="'+sid+'" data-nm="'+nm+'" data-yld="'+yld+'" data-avg="'+avg+'" data-fil="'+r.avg_fillet_pct+'" data-nug="'+r.avg_nugget_pct+'" data-mis="'+r.avg_misccut_pct+'" data-gl="'+g.l+'" data-gbg="'+g.bg+'" data-gc="'+g.c+'" data-base="'+g.base+'" data-fails="'+encodeURIComponent(JSON.stringify(g.fails))+'" style="border:none;background:none;cursor:pointer;font-size:1rem;color:'+trendCol+';font-weight:700;padding:2px 5px;border-radius:4px" title="View breakdown">'+trendIcon+'</button></td>';
