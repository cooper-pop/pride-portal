...
async function todoSchedule(body) {
  ...
  html += '<div style="text-align:center"><div style="font-weight:700;color:#1a3a6b">'+dayLabel+'</div><div style="font-size:.75rem;color:#94a3b8">'+_todoDate+(currentUser&&currentUser.role==='admin'?
            ...
            '<button class="sched-edit-btn" data-tid="'+(t.task_id||t.id||0)+'" style="flex:1;background:#1a3a6b;color:#fff;border:none;border-radius:6px;padding:5px;cursor:pointer;font-size:.75rem;font-weight:600">✏️ Edit Task</button>'+
